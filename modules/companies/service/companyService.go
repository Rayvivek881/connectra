...
type CompanySvcRepo interface {
	...
	BulkUpsert(pgCompanies []*models.PgCompany, osCompanies []*models.OpenSearchCompany) ([]string, error)
...
func (s *CompanyService) BulkUpsert(pgCompanies []*models.PgCompany, osCompanies []*models.OpenSearchCompany) ([]string, error) {
	...
	return uuids, s.BulkUpsertToDb(pgCompanies, osCompanies, filtersData)
}
