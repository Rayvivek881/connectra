...
func BatchUpsert(c *gin.Context) {
	...
	companyUuids, _ := service.NewCompanyService(tempFilters).BulkUpsert(pgCompanies, osCompanies)
	c.JSON(http.StatusOK, gin.H{"success": true, "company_uuids": companyUuids})
}
